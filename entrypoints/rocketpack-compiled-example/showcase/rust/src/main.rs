...
mod tests {
    ...
    fn generated_wire_bytes_remain_stable() {
        const EXPECTED: &[u8] = &[
            ,
        ];
    ...
    fn decode_rejects_lengths_at_each_prefix_position() {
        ...
        assert_length_error(
            &[&[0xA1, 0x18, 0x19, 0x89][..], &[0x00; 9][..]].concat(),
            "PrimitiveShowcase1.vec_field_1_constrained",
            9,
            3,
        );
        assert_length_error(
            &[&[0xA1, 0x18, 0x1C, 0xA5][..], &[0x00; 10][..]].concat(),
            "PrimitiveShowcase1.map_field_1_constrained",
            5,
            3,
        );
    }
