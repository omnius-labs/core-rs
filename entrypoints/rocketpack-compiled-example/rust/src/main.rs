...
mod tests {
    ...
    fn generated_wire_bytes_remain_stable() {
        const EXPECTED: &[u8] = &[
            ,
        ];
    ...
    fn decode_rejects_lengths_at_each_prefix_position() {
        assert_length_error(&[0xA1, 0x0E, 0x60], "PrimitiveShowcase1.string_field", 0, 2);
        assert_length_error(&[0xA1, 0x0E, 0x78, 33], "PrimitiveShowcase1.string_field", 33, 2);
        assert_length_error(&[0xA1, 0x0F, 0x40], "PrimitiveShowcase1.bytes_field", 0, 2);
        assert_length_error(&[0xA1, 0x12, 0x81, 0x49], "PrimitiveShowcase1.vec_field_3[]", 9, 3);
        assert_length_error(&[0xA1, 0x10, 0x80], "PrimitiveShowcase1.vec_field_1", 0, 2);
        assert_length_error(&[0xA1, 0x10, 0x89], "PrimitiveShowcase1.vec_field_1", 9, 2);
        assert_length_error(&[0xA1, 0x13, 0xA0], "PrimitiveShowcase1.map_field_1", 0, 2);
        assert_length_error(&[0xA1, 0x13, 0xA5], "PrimitiveShowcase1.map_field_1", 5, 2);
    }
